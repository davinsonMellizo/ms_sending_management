...
public enum TechnicalExceptionEnum {
    ...
    //DELETE_CLIENT_ERROR("T0008", "An error occurred while delete client","500"),
    ...
    //FIND_ENROLLMENT_CONTACT_ERROR("T0012", "An error occurred while find enrollment contact","500"),
    ...
    //JSON_CONVERT_ERROR("T0017", "Error converting the Object to String","500"),
