    ...
    private Mono<Response> sendSMSInalambria(Alert alert,TemplateSms templateSms ) {
        ...
        return Mono.just(alert.getProvider())
                ...
                .map(provider -> SMSInalambria.builder()
                        ...
                        .Devices(alert.getDestination().getPrefix()+alert.getDestination().getPhoneNumber())
    ...
    private Mono<Response> sendSMSMasivian(Alert alert,  TemplateSms templateSms) {
        ...
        return Mono.just(alert.getProvider())
                ...
                .map(provider -> SMSMasiv.builder()
                        ...
                        .to(alert.getDestination().getPrefix()+alert.getDestination().getPhoneNumber())
                        .isPremium(alert.getIsPremium()).isFlash(alert.getIsFlash())
                        .isLongmessage(alert.getIsLongMessage())
                        .build())
        ...
        return Mono.just(alert.getProvider())
                ...
                .map(provider -> SMSInfobip.builder()
                        .message(SMSInfobip.Message.builder()
                                .from("InfobipSMS")
                                .destination(SMSInfobip.Destination.builder().to(alert.getDestination().getPrefix()
                                        +alert.getDestination().getPhoneNumber()).build())
