...
public enum TechnicalExceptionEnum {
    ...
    FIND_ALL_REMITTERS_ERROR("DST0001", "An error occurred while find all remitters"),
    ...
    FIND_ALL_PROVIDERS_ERROR("DST0001", "An error occurred while find all providers"),
