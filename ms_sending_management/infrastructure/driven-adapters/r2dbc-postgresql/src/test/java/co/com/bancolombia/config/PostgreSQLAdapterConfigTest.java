...
class PostgreSQLAdapterConfigTest {
    ...
    public void init() throws NoSuchFieldException, IllegalAccessException {
        ...
        final Field initialSize = PostgreSQLAdapterConfig.class.getDeclaredField("initialSize");
        initialSize.setAccessible(true);
        initialSize.set(adapterConfig, 1);

        final Field maxSize = PostgreSQLAdapterConfig.class.getDeclaredField("maxSize");
