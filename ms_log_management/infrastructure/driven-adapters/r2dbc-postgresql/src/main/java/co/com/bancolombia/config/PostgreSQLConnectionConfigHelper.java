...
public class PostgreSQLConnectionConfigHelper {
    ...
    @Value("${cloud.aws.secrets-manager.secret-rds}")
    ...
    public ConnectionFactoryOptions buildConnectionReaderConfiguration(@Value("${cloud.aws.rds.postgresql.schema}") String schema,
        ...
        return ConnectionFactoryOptions.builder()
                ...
                .option(DRIVER,"pool")
                .option(PROTOCOL, "postgresql")
                .option(HOST, "nu0154001-alertas-logs-dev-clusteraurora.cluster-cuudzr7pgeql.us-east-1.rds.amazonaws.com")
                .option(PORT, 5432)
                .option(USER,"cnxalerd")
                .option(PASSWORD,"TryLlS4o9_4SJGc")
                .option(DATABASE, "alerldcd")
                .option(Option.valueOf("sslmode"), "verify-full")
                .option(Option.valueOf("schema"), schema)
                .build();
    }
